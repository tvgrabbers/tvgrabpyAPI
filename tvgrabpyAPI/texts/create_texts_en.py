    ...
    texts = {
        u'config':{
            u'error':{
                ...
                47: u'Invalid starttime for %s\n  Setting it to midnight!',
                48: u'Invalid endtime for %s\n  Setting it to midnight!',
            ...
            u'confighelp':{
                ...
                14: u'# leave the value to True to profit from all updates.\n',
                15: u'',
                16: u'',
                ...
                30: u'#    This won\'t significantly alter the total runtime as this is mostly determined\n',
                31: u'#    by the highest number of fetches from a single source and the mandatory.\n',
                32: u'#    wait-time in between those fetches to not overload their resources.\n',
                33: u'#    However all basepage fetches are retried on failure and a detailpagefailure\n',
                34: u'#    can trigger a retry on one of the other detailsources. So a lot of failures\n',
                ...
                52: u'# 512 Print Queue Status every 5 min to the screen\n',
                53: u'',
                ...
                67: u'',
                71: u'# Set "mail_log" to True to send the log to the mail-address below\n',
                72: u'# Also set the mailserver and port appropriate\n',
                ...
                157: u'# Add "none" to include programs without genre info\n',
                158: u'# Add "all" to this list to include all programs\n',
                159: u'#    for all other genres in the list now NO details will be fetched!\n',
                160: u'',
                161: u'',
                162: u'# These are the translation lists for:\n',
                163: u'# to common genre:subgenre. If you have cattrans enabled, they will next\n',
                164: u'# be converted according to the list further down.\n',
                165: u'',
                166: u'# The genres from:\n',
                167: u'# %s are treated as subgenres\n',
                168: u'# These are lists of genres to add to these subgenres\n',
                169: u'# New found "subgenres" are automatically added and matched on generic rules\n',
                170: u'',
                171: u'# This is the "Genre:Subgenre" conversion table used by cattrans\n',
                172: u'# "Genre:Subgenre" will automatically be converted to lowercase\n',
                173: u'# and leading and following spaces will be removed\n',
                174: u'# It will automatically get sorted with the genres without\n',
                175: u'# a subgenre at the top.\n',
                176: u'# Also new found values will be added on every new scan\n',
                177: u'',
                178: u'# Behind the "=" you can supply the category to be used\n',
                179: u'# If a category value is empty the main category or an existing\n',
                180: u'# default will be used\n',
                181: u'# If a main category is empty the default will be supplied\n',
                182: u'# and used. If no default exists "Unknown" will be used.\n',
        ...
        u'fetch':{
            u'error':{
                ...
                13: u'An error "%s" occured while extracting a DataTree\n',
                ...
                25: u'Error retrieving the %s URL for source: %s from the json data_def\n',
                ...
                54: u' and %s',
                55: u'%s has died before setting the %s channel ready. We stop waiting!\n'
                },
            u'report':{
        ...
        u'ttvdb':{
            u'error':{
                ...
                16: u'No episode data for %s found on theTVDB.com\n'
                },
            u'frontend':{
                0: u'',
                ...
                13: u'    Do you want to replace it with %s ("%s")? <y/n>\n',
                14: u'The given ttvdbid %s is unknown on theTVDB.com!',
                15: u'Please press y or n.',
                16: u'    Do you want to add it as %s ("%s")? <y/n>\n'
                }}}
    return texts
